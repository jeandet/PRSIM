...
- [x] **Step 1: Define the Checkbox sentinel type**
...
- [x] **Step 2: Add draw_check_box() free function**
...
- [x] **Step 1: Write failing test — Delegate<bool> renders a checkbox box outline**
...
- [x] **Step 3: Replace Delegate<bool>::record with checkbox box rendering**
...
- [x] **Step 1: Write failing tests for Checkbox delegate**
...
- [x] **Step 3: Implement Delegate<Checkbox>**
...
- [x] **Step 1: Add Field<Checkbox> to Settings struct**
...
- [x] **Step 2: Add an observer for the checkbox**
...
- [x] **Step 3: Build and verify the example runs**
...
- [x] **Step 1: Add Checkbox to the interactive focus policy test**
