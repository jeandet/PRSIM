...
- [x] **Step 1: Write test for new key constants**
...
- [x] **Step 3: Add key constants to `input_event.hpp`**
...
- [x] **Step 1: Add `overlay` field to `SceneSnapshot`**
...
- [x] **Step 1: Add `overlay_draws` field to `WidgetNode`**
...
- [x] **Step 2: Add `close_overlays()` to `WidgetTree`**
...
- [x] **Step 3: Pass overlay draws through the layout system**
...
- [x] **Step 4: Update `build_layout` to carry overlay draws**
...
- [x] **Step 5: Update `layout_flatten` to collect overlay draws into snapshot**
...
- [x] **Step 6: Update `refresh_dirty` to also refresh overlay draws**
...
- [x] **Step 1: Render overlay after main scene**
...
- [x] **Step 2: Write tests for types and reflection helpers**
...
- [x] **Step 1: Write rendering tests for enum delegate**
...
- [x] **Step 2: Write popup rendering tests**
...
- [x] **Step 4: Implement shared dropdown helpers and enum delegate in `widget_tree.hpp`**
...
- [x] **Step 1: Write custom labels tests**
...
- [x] **Step 1: Call `close_overlays()` on click-outside**
...
- [x] **Step 1: Add enum to focus policy test**
...
- [x] **Step 1: Add an enum and Field to the model**
